...
to get the number of times a word occurred. Hint: The test for this file counts words which are parts of other words (ex 'laws' will count for 'law', but "Law" would not count (case sensitive)). In real life, you would want to be more careful about word/character counting, but we aren't going that far into text processing.
